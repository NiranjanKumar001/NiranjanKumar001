...
<img src="https://skillicons.dev/icons?i=html,css,js,python,typescript,react,nextjs,tailwindcss,express,nodejs,mongodb,npm,powershell,redux,styledcomponents,vscode,windows,yarn,vite,bash,git,github,bootstrap,c,java,figma,firebase,githubactions,gitlab,gmail,kali,linux,md,materialui,docker,netlify,vercel,postman,notion,blender,threejs,ruby,vuejs,rails" />
